 ...
 */
public class RSTReportHandler extends AbstractModelSelectionHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
        ...
        if(model != null) {
            try {
                ...
                MessageDialog.openError(workbenchWindow.getShell(), Messages.RSTReportAction_0, ex.getMessage());
                ex.printStackTrace();
            }
        }
